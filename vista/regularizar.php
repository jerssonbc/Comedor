                                ...
                                <form role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputFile">Subir Ficha de Matricula</label>
                                            <input type="file" id="exampleInputFile">
                                            <p class="help-block">Example block-level help text here.</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">Subir Voucher</label>
                                            <input type="file" id="exampleInputFile">
                                            <p class="help-block">Example block-level help text here.</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Numero Operación</label>
